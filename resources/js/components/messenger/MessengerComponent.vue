                                ...
                                <div class="d-flex justify-content-start mb-4" v-else>
                                    <div class="img_cont_msg">
                                        <a :href="'/home/guest/'+message.from_id">
                                            <img
                                                src="https://2.bp.blogspot.com/-8ytYF7cfPkQ/WkPe1-rtrcI/AAAAAAAAGqU/FGfTDVgkcIwmOTtjLka51vineFBExJuSACLcBGAs/s320/31.jpg" class="rounded-circle" width="30px">
                                        </a>
                                    </div>
                ...
                this.polling = setInterval(() => {
                    if(this.partner == []) {
                        ...
                        if(this.lastInsertMessageId != '') {
                            ...
                            var lastMessageId = {
                                'id' : this.messageInfo[this.messageInfo.length - 1].id,
                                'from_id': this.myInfo.id,
                                'to_id':   this.partner.id
                            };
                        }
